...
vehiculo1 = Auto("AB1234", 2018) # Instancia el primer objeto Vehiculo pasándole su patente y año
vehiculo2 = Moto("CD5678", 2020) # Instancia el segundo objeto Vehiculo pasándole su patente y año
vehiculo3 = Camion("EF9012", 2023, 5000) # Instancia el tercer objeto Vehiculo pasándole su patente y año
